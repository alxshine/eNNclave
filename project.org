...
**** DONE [#A] Read related work [3/5]                                  :sgx:
...
***** TODO [#A] Model stealing
      SCHEDULED: <2019-10-24 Thu>
A good paper on model stealing seems to be [[file:related_work/tramer16stealing.pdf][this one]], which Daniel recommended to me.
