...
*** TODO Limitation: microcode updates and mitigations will carry performance reductions :sgx:
*** TODO Test if our processors are vulnerable to foreshadow            :sgx:
   [2019-10-04 Fri 11:46]

 If they are, don't update, we want to measure performance impact of that update
