...
python tikz_generation.py --model models/mit.h5 --time timing_logs/mit_times_cpu.csv timing_logs/mit_times_gpu.csv --ymin -3 --ymax 3 > mit.tex
...
python tikz_generation.py --model models/flowers.h5 --time timing_logs/flowers_times_cpu.csv --ymin -2 --ymax 3 > flowers.tex
