...
**** DONE [#A] Read related work [4/6]                                  :sgx:
...
****** TODO Talk to Rainer about the k=1 label case for set membership attacks
       SCHEDULED: <2019-10-28 Mon>
...
Dan Boneh released [[file:related_work/tramer19slalom.pdf][this paper]] with Florian Tramer, talking about something very similar to what we're doing.

[2019-10-15 Tue 10:50]
They do talk about something similar to what we're doing, but they're doing it very differently.
Instead of running parts of the NN in the enclave, they run it on the GPU and verify its outputs.
Also they apply some encryption mechanism to the input to keep it private from the model owner.
...
***** TODO Accountability/Authentication for NNs
