...
**** TODO Design a splitting functionality for Keras [1/2]
...
***** TODO Write extension to Keras Sequential [0/7]
...
- [ ] Extend Keras ~Sequential~
- [ ] Store input shape of the first layer
- [ ] Store output shapes of all layers
- [ ] Store weights of layers
- [ ] Store biases if applicable
- [ ] Generate matrix multiplications
