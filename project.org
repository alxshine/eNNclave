...
**** TODO Test on actual hardware [16/20]                               :sgx:
...
***** TODO Get a second media type (e.g. Malware dataset)
...
****** TODO Test different vgg_lfw variants                             :sgx:
    ...
    - dense on flattened
    - globalmean with more dense neurons
...
**** DONE [#A] Read related work [4/7]                                  :sgx:
...
***** TODO Layer freezing in transfer learning
